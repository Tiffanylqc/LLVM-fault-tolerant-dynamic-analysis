; ModuleID = '<stdin>'
source_filename = "/home/qingcanl/Documents/a5/se-fault-tolerant-template/test/c/read-failure-propagates.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define i32 @divideByValue(i32, i32) #0 {
...
; Function Attrs: noinline nounwind optnone uwtable
define i32 @propagate(i32, i32) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
  store i32 %1, i32* %4, align 4
